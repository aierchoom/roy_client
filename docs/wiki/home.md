...
| [架构概览](architecture-overview.md) | 系统架构与技术选型 |
| [代码详细解读](code-analysis.md) | 核心代码逐行分析 |
...
| [质量收敛报告](../reports/quality-convergence/README.md) | 代码质量改进记录 |
...
| [密钥同步实现](../security/key-sync-implementation.md) | 安全链接码、服务器配对与 LAN 直连配对 |
...
- [技术实现指南](../guides/technical-implementation-guide.md)
- [白皮书](../product/whitepaper.md)
