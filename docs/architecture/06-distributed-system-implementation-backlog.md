...
[Quality Iteration Plan](05-distributed-system-quality-iteration-plan.md)
...
- `docs/sync/sync-protocol.md`
- `docs/architecture/05-distributed-system-quality-iteration-plan.md`
