...
> 如果你想看“架构评审/专业解读”风格，而不是初学者教程，请直接阅读：`docs/SECRETROY_ARCHITECTURE_DEEP_DIVE.md`
...
- `BETA_RISK_REGISTER.md`
- `BETA_TECHNICAL_DELIVERY.md`
- `secret_roy_sync_protocol.md`
- `secret_roy_whitepaper.md`
- `FLUTTER_NODE_BEGINNER_TUTORIAL.md`
