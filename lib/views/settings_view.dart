  ...
  Widget build(BuildContext context) {
    ...
    final children = <Widget>[
      ...
      AppSettingsTile(
        ...
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute(builder: (context) => const SyncSettingsView()),
          );
        },
      ),
      AppSettingsTile(
        ...
        subtitle: context.text(
          '密码过期提醒阈值与推送',
          'Password expiry threshold & push',
        ),
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute(
      ...
      AppSettingsTile(
        ...
        subtitle: context.text('生成高强度密码', 'Generate strong passwords'),
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute(builder: (context) => const PasswordToolsView()),
          );
        },
      ),
      AppSettingsTile(
        ...
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute(builder: (context) => const ReleaseNoteView()),
          );
        },
      ),
    ];
      ...
      child: ListView(
        ...
        children: [
          ...
          AdaptiveSection(
            ...
            child: AppSettingsGroup(children: children),
          ),
        ],
      ),
    );
